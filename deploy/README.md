...
OAuth rollout warning: live shared authority is now **schema 2**, following the separately reviewed
post-GW5 [quiet-window rollout](../docs/shared-x-oauth-rollout.md). Do not deploy schema-1 images,
